...
using Artyfy.Dal.Data.IDalRepos;
using Artyfy.Domain.IdentityModels;

namespace Artyfy.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
    {
        protected readonly ArtyfyDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(ArtyfyDbContext dbContext)
        {
