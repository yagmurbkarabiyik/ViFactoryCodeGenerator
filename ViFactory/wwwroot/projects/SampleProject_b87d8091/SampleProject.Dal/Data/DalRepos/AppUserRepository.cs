...
using SampleProject.Dal.Data.IDalRepos;
using SampleProject.Domain.IdentityModels;

namespace SampleProject.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
     {
        protected readonly SampleProjectDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(SampleProjectDbContext dbContext)
        {
