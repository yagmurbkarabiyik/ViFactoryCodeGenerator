...
using New.Dal.Context;
using New.Dal.Data.IDalRepos;
using New.Domain.IdentityModels;

namespace New.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
    {
        protected readonly NewDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(NewDbContext dbContext)
        {
