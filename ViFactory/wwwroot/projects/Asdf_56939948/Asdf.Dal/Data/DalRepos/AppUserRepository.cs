...
using Asdf.Dal.Context;
using Asdf.Dal.Data.IDalRepos;
using Asdf.Domain.IdentityModels;

namespace Asdf.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
     {
        protected readonly AsdfDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(AsdfDbContext dbContext)
        {
