...
using Ybk.Dal.Context;
using Ybk.Dal.Data.IDalRepos;
using Ybk.Domain.IdentityModels;

namespace Ybk.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
     {
        protected readonly YbkDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(YbkDbContext dbContext)
        {
