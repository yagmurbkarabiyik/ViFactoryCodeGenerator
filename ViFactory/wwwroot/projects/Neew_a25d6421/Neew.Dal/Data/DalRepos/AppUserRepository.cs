...
using Neew.Dal.Context;
using Neew.Dal.Data.IDalRepos;
using Neew.Domain.IdentityModels;

namespace Neew.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
    {
        protected readonly NeewDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(NeewDbContext dbContext)
        {
