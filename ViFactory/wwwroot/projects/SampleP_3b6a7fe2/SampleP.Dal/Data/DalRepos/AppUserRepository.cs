...
using SampleP.Dal.Context;
using SampleP.Dal.Data.IDalRepos;
using SampleP.Domain.IdentityModels;

namespace SampleP.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
     {
        protected readonly SamplePDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(SamplePDbContext dbContext)
        {
