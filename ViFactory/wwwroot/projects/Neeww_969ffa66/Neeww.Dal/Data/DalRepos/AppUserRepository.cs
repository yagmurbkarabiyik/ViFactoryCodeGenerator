...
using Neeww.Dal.Context;
using Neeww.Dal.Data.IDalRepos;
using Neeww.Domain.IdentityModels;

namespace Neeww.Dal.Data.DalRepos
{
     public class AppUserRepository : IAppUserRepository
    {
        protected readonly NeewwDbContext _dbContext;
        private readonly DbSet<AppUser> _dbSet;

        public AppUserRepository(NeewwDbContext dbContext)
        {
