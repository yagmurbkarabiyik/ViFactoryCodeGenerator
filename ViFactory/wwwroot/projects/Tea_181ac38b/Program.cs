		...
		foreach (var entity in entities)
		{
			...
			if (entity.Name != "BaseEntity")
			{
				...
				EnsureFileExists(unitOfWorkClass, File.ReadAllText("./Templates/UnitOfWork.txt")
					 .Replace("", currentProjectName)
					 .Replace("", $"{currentProjectName}DbContext"));
			}
		}
